...
?>
<div class="w-100">
<h3 class="d-inline-block ml-2 float-left">Les disciplines enseignées dans l'école section primaire</h3>

	<a href=" <?= $router->urlPut('NewDiscipline', ['level' => 'primaire']) ?> " class="btn btn-news float-right m-2" >Inserer une nouvelle discipline</a>
