...
<div class="w-100 mb-3">
	...
	<div class="m-auto w-100">
		<div class="m-auto d-table w-50">
			...
			<a href=" <?= $router->urlPut('AdminClassesByLevel', ['level' => 'primaire']) ?> " class="btn-news btn mt-1 w-100 d-block">Le primaire</a>
			<a href=" <?= $router->urlPut('AdminClassesByLevel', ['level' => 'secondaire']) ?> " class="btn-news btn mt-1 w-100 d-block">Le secondaire (Premier cycle - second cycle)</a>
